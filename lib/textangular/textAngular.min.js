!function (a, b) {
   ...
   */
    angular.module("textAngularSetup", []).value("taOptions", {
      ...
      angular.forEach(["h1", "h2", "h3", "h4", "h5", "h6"], function (b) {
        ...
        iconclass: "fa fa-align-justify", tooltiptext: c.justifyFull.tooltip, action: function () {
   ...
   */
    function () {
            ...
            if (void 0 !== u) {
              ...
              if ("insertorderedlist" === k.toLowerCase() || "insertunorderedlist" === k.toLowerCase()) {
                ...
                if ("formatblock" === k.toLowerCase()) {
                  for (t = m.toLowerCase().replace(/[<>]/gi, ""), "default" === t.trim() && (t = g, m = "<" + g + ">"), p = "li" === y ? x.parent() : x; !p[0].tagName || !p[0].tagName.match(e) && !p.parent().attr("contenteditable");)p = p.parent(), y = (p[0].tagName || "").toLowerCase();
                  if (y === t) {
                    r = p.children();
                    var D = !1;
      ...
      }]).directive("taBind", ["taSanitize", "$timeout", "$window", "$document", "taFixChrome", "taBrowserTag", "taSelection", "taSelectableElements", "taApplyCustomRenderers", "taOptions", "_taBlankTest", "$parse", "taDOM", "textAngularManager", function (a, b, f, h, k, l, m, n, o, q, r, s, t, u) {
        return {
          priority: 2, require: ["ngModel", "?ngModelOptions"], link: function (l, v, w, x) {
            ...
            void 0 === w.taDefaultWrap && (w.taDefaultWrap = "p"), "" === w.taDefaultWrap ? (B = "", C = void 0 === c.ie ? "<div><br></div>" : c.ie >= 11 ? "<p><br></p>" : c.ie <= 8 ? "<P>&nbsp;</P>" : "<p>&nbsp;</p>") : (B = void 0 === c.ie || c.ie >= 11 ? "<" + w.taDefaultWrap + "><br></" + w.taDefaultWrap + ">" : c.ie <= 8 ? "<" + w.taDefaultWrap.toUpperCase() + "></" + w.taDefaultWrap.toUpperCase() + ">" : "<" + w.taDefaultWrap + "></" + w.taDefaultWrap + ">", C = void 0 === c.ie || c.ie >= 11 ? "<" + w.taDefaultWrap + "><br></" + w.taDefaultWrap + ">" : c.ie <= 8 ? "<" + w.taDefaultWrap.toUpperCase() + ">&nbsp;</" + w.taDefaultWrap.toUpperCase() + ">" : "<" + w.taDefaultWrap + ">&nbsp;</" + w.taDefaultWrap + ">"), E.$options || (E.$options = {});
            var S = r(C), T = function (a) {
              ...
              if (0 === b.children().length)a = "<" + w.taDefaultWrap + ">" + a + "</" + w.taDefaultWrap + ">"; else {
                ...
                if (f)for (a = "", c = 0; c < d.length; c++)if (d[c].nodeName.toLowerCase().match(e))a += d[c].outerHTML; else {
                  ...
                  a += "" !== g.trim() ? "<" + w.taDefaultWrap + ">" + g + "</" + w.taDefaultWrap + ">" : g
            ...
            l["$undoManager" + (w.id || "")] = D.$undoManager = {
              _stack: [], _index: 0, _max: 1e3, push: function (a) {
                return "undefined" == typeof a || null === a || "undefined" != typeof this.current() && null !== this.current() && a === this.current() ? a : (this._index < this._stack.length - 1 && (this._stack = this._stack.slice(0, this._index + 1)), this._stack.push(a), U && b.cancel(U), this._stack.length > this._max && this._stack.shift(), this._index = this._stack.length - 1, a)
              }, undo: function () {
            ...
            var V, W = l["$undoTaBind" + (w.id || "")] = function () {
              if (!H && F) {
                ...
                "undefined" != typeof a && null !== a && (ja(a), Z(a, !1), V && b.cancel(V), V = b(function () {
              ...
              J = c || !1, ("undefined" == typeof b || null === b) && (b = !0 && F), ("undefined" == typeof a || null === a) && (a = Y()), S(a) ? ("" !== D.$viewValue && D.$setViewValue(""), b && "" !== D.$undoManager.current() && D.$undoManager.push("")) : (ia(), D.$viewValue !== a && (D.$setViewValue(a), b && D.$undoManager.push(a))), D.$render()
            };
            ...
            if (v.attr("required") && (D.$validators.required = function (a, b) {
              ...
              var _ = !1, aa = function (c) {
                if (c && c.trim().length) {
                  ...
                  /<li(\s.*)?>/i.test(c) && /(<ul(\s.*)?>|<ol(\s.*)?>).*<li(\s.*)?>/i.test(c) === !1 && (c = c.replace(/<li(\s.*)?>.*<\/li(\s.*)?>/i, "<ul>$&</ul>")), A && (c = A(l, {$html: c}) || c), c = a(c, "", K), m.insertHtml(c, v[0]), b(function () {
                    D.$setViewValue(Y()), _ = !1, v.removeClass("processing-paste")
                  }, 0)
                } else _ = !1, v.removeClass("processing-paste")
              };
              v.on("paste", l.events.paste = function (a, c) {
                if (c && angular.extend(a, c), H || _)return a.stopPropagation(), a.preventDefault(), !1;
                ...
                if (e && e.getData && e.types.length > 0) {
                  ...
                  return /text\/html/i.test(g) ? d = e.getData("text/html") : /text\/plain/i.test(g) && (d = e.getData("text/plain")), aa(d), a.stopPropagation(), a.preventDefault(), !1
                }
              ...
              var ba;
              if (v.on("keyup", l.events.keyup = function (a, c) {
                  if (c && angular.extend(a, c), 9 === a.keyCode) {
                    var d = m.getSelection();
                    return void(d.start.element === v[0] && v.children().length && m.setSelectionToElementStart(v.children()[0]))
                  }
                  if (U && b.cancel(U), !H && !L.test(a.keyCode)) {
                    if ("" !== B && 13 === a.keyCode && !a.shiftKey) {
                      for (var e = m.getSelectionElement(); !e.tagName.match(g) && e !== v[0];)e = e.parentNode;
                      if (e.tagName.toLowerCase() !== w.taDefaultWrap && "li" !== e.tagName.toLowerCase() && ("" === e.innerHTML.trim() || "<br>" === e.innerHTML.trim())) {
                        var h = angular.element(B);
                        angular.element(e).replaceWith(h), m.setSelectionToElementStart(h[0])
                      }
                    }
                    var i = Y();
                    if ("" !== B && "" === i.trim())ja(B), m.setSelectionToElementStart(v.children()[0]); else if ("<" !== i.substring(0, 1) && "" !== w.taDefaultWrap) {
                      var j = f.rangy.saveSelection();
                      i = Y(), i = "<" + w.taDefaultWrap + ">" + i + "</" + w.taDefaultWrap + ">", ja(i), f.rangy.restoreSelection(j)
                    }
                    var k = z !== a.keyCode && M.test(a.keyCode);
                    ba && b.cancel(ba), ba = b(function () {
                      Z(i, k, !0)
                    }, E.$options.debounce || 400), k || (U = b(function () {
                      D.$undoManager.push(i)
                    }, 250)), z = a.keyCode
                  }
                }), v.on("blur", l.events.blur = function () {
                  I = !1, H ? (J = !0, D.$render()) : Z(void 0, void 0, !0)
                }), w.placeholder && (c.ie > 8 || void 0 === c.ie)) {
                var ca;
              ...
              v.on("focus", l.events.focus = function () {
                I = !0, v.removeClass("placeholder-text"), ia()
              ...
              var da = function (a, b) {
                ...
                b++, c += da("	", b - 1) + a.outerHTML.substring(0, a.outerHTML.indexOf("<li"));
              ...
              D.$formatters.unshift(function (a) {
                ...
                if (b.length > 0) {
                  a = "";
                  for (var c = 0; c < b.length; c++)b[c].outerHTML && (a.length > 0 && (a += "\n"), a += "ul" === b[c].nodeName.toLowerCase() || "ol" === b[c].nodeName.toLowerCase() ? "" + ea(b[c], 0) : "" + b[c].outerHTML)
                }
                return a
              })
            }
            ...
            }, ia = l["reApplyOnSelectorHandlers" + (w.id || "")] = function () {
            ...
            D.$render = function () {
              if (!ka) {
                ka = !0;
                var a = D.$viewValue || "";
                J || (F && I && (v.removeClass("placeholder-text"), fa && b.cancel(fa), fa = b(function () {
                  I || (v[0].focus(), m.setSelectionToElementEnd(v.children()[v.children().length - 1])), fa = void 0
                }, 1)), F ? (ja(w.placeholder ? "" === a ? B : a : "" === a ? B : a), H ? v.off("drop", ha) : (ia(), v.on("drop", ha))) : "textarea" !== v[0].tagName.toLowerCase() && "input" !== v[0].tagName.toLowerCase() ? ja(o(a)) : v.val(a)), F && w.placeholder && ("" === a ? I ? v.removeClass("placeholder-text") : v.addClass("placeholder-text") : v.removeClass("placeholder-text")), ka = J = !1
              }
              ...
              }), v.off("drop", ha)) : (v.removeClass("ta-readonly"), "textarea" === v[0].tagName.toLowerCase() || "input" === v[0].tagName.toLowerCase() ? v.removeAttr("disabled") : F && v.attr("contenteditable", "true"),
                angular.forEach(n, function (a) {
                  v.find(a).off("click", ga)
                }), v.on("drop", ha)), H = a)
            })), F && !H && (angular.forEach(n, function (a) {
              v.find(a).on("click", ga)
            }), v.on("drop", ha), v.on("blur", function () {
              c.webkit && (d = !0)
            }))
          }
        }
            ...
            o.taTextEditorSetup && (m.setup.textEditorSetup = m.$parent.$eval(o.taTextEditorSetup)), o.taHtmlEditorSetup && (m.setup.htmlEditorSetup = m.$parent.$eval(o.taHtmlEditorSetup)), o.taFileDrop ? m.fileDropHandler = m.$parent.$eval(o.taFileDrop) : m.fileDropHandler = m.defaultFileDropHandler, w = n[0].innerHTML, n[0].innerHTML = "", m.displayElements = {
              ...
              z = function (c) {
                ...
                var e = d.height / d.width, f = function (b) {
                  ...
                  }, f = void 0 !== o.taResizeForceAspectRatio, g = o.taResizeMaintainAspectRatio, h = f || g && !b.shiftKey;
                  if (h) {
                    var i = c.y / c.x;
                    c.x = e > i ? c.x : c.y / e, c.y = e > i ? c.x * e : c.y
                  }
                  var j = angular.element(a);
                  j.css("height", Math.round(Math.max(0, c.y) + "px")), j.css("width", Math.round(Math.max(0, c.x) + "px")), m.reflowResizeOverlay(a)
                };
